...
float3 CalcAllLights(Light lights[MAX_LIGHT_COUNT], int lightCount, float3 albedo, float3 normal, float3 cameraPosition, float3 worldPosition, float roughness, float metalness, float3 f0)
{
    float3 lightSum = 0;
